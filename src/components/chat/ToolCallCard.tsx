...
import { IconCheck, IconAlert, IconBranch, IconFolder, IconFile, IconPencil, IconTerminal } from '@/components/common/icons'
...
export function ToolCallCard({ call }: { call: ToolCall }) {
  ...
  if (call.name === 'dispatch_subtasks' || call.name === 'Agent' || call.name === 'Task') return <AgentToolCard call={call} />
